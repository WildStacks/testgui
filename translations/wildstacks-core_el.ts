...
<context>
    ...
    <message>
        ...
        <source>This makes it easier to send or receive WildStacks and reduces errors when typing in addresses manually.</source>
        <translation>Αυτό διευκολύνει την αποστολή ή λήψη του WildStacks και μειώνει τα σφάλματα κατά τη χειροκίνητη πληκτρολόγηση διευθύνσεων.</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <source>WARNING: Do not reuse your WildStacks keys on another fork, UNLESS this fork has key reuse mitigations built in. Doing so will harm your privacy.</source>
        <translation>ΠΡΟΣΟΧΗ: Μην επαναχρησιμοποιείτε τα κλειδιά του WildStacks σε άλλη διακλάδωση, ΕΚΤΟΣ κι αν αυτή η διακλάδωση έχει ενσωματωμένο μετριασμό επαναχρησιμοποίησης κλειδιού . Κάνοντας το αυτό θα βλάψει την ιδιωτικότητα σας.</translation>
    </message>
    <message>
        <location filename="../pages/Keys.qml" line="85"/>
        <source>WARNING: Copying your seed to clipboard can expose you to malicious software, which may record your seed and steal your WildStacks. Please write down your seed manually.</source>
        <translation>ΠΡΟΣΟΧΗ: Αντιγράφοντας την φράση σας στο πρόχειρο μπορεί να σας εκθέσει σε κακόβουλο λογισμικό, το οποίο μπορεί να καταγράψει την φράση σας και να κλέψει τα WildStacks σας. Παρακαλώ γράψτε την φράση σας χειροκίνητα.</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <source>Mining with your computer helps strengthen the WildStacks network. The more that people mine, the harder it is for the network to be attacked, and every little bit helps.

Mining also gives you a small chance to earn some WildStacks. Your computer will create hashes looking for block solutions. If you find a block, you will get the associated reward. Good luck!</source>
        <translation>Η εξόρυξη με τον υπολογιστή σας βοηθά στην ενίσχυση του δικτύου WildStacks. Όσο περισσότερο οι άνθρωποι κάνουν εξόρυξη, τόσο πιο δύσκολο είναι να γίνει επίθεση κατά του δικτύου, και κάθε βοήθεια είναι χρήσιμη.

Η εξόρυξη σας δίνει επίσης μια μικρή ευκαιρία να κερδίσετε WildStacks. Ο υπολογιστής σας θα δημιουργήσει hashes αναζητώντας λύσεις για τα block. Εάν βρείτε ένα block, θα λάβετε τη σχετική ανταμοιβή. Καλή τύχη!</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <source>Embedded WildStacks version: </source>
        <translation>Ενσωματωμένη έκδοση WildStacks: </translation>
    </message>
    <message>
...
Το παλιό αρχείο προσωρινής μνήμης πορτοφολιού θα μετονομαστεί και μπορεί να αποκατασταθεί αργότερα.
    ...
    <message>
        ...
        <source>Donate to WildStacks</source>
        <translation>Κάντε δωρεά στο WildStacks</translation>
    </message>
</context>
<context>
...
<context>
    ...
    <message>
        ...
        <source>Uses a third-party server to connect to the WildStacks network. Less secure, but easier on your computer.</source>
        <translation>Χρησιμοποιεί διακομιστή από τρίτο πάροχο για τη σύνδεση στο δίκτυο του WildStacks. Λιγότερο ασφαλές, αλλά ελαφρύτερο για τον υπολογιστή σας.</translation>
    </message>
    <message>
        <location filename="../pages/settings/SettingsNode.qml" line="262"/>
        <source>To find a remote node, type &apos;WildStacks remote node&apos; into your favorite search engine. Please ensure the node is run by a trusted third-party.</source>
        <translation>Για την εύρεση απομακρυσμένου κόμβου, πληκτρολογήστε &apos;WildStacks remote node&apos; στην αγαπημένη σας μηχανή αναζήτησης. Παρακαλώ διαβεβαιώστε πως ο κόμβος λειτουργεί μέσω αξιόπιστου τρίτου παρόχου.</translation>
    </message>
    <message>
...
Μπορείτε να αλλάξετε τον κωδικό πρόσβασης στις ρυθμίσεις πορτοφολιού.</translation>
    ...
    <message>
        ...
        <source>Receive WildStacks for your business, easily.</source>
        <translation>Λάβετε WildStacks για την επιχείρηση σας με ευκολία.</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <source>This page allows you to interact with the shared ring database. This database is meant for use by WildStacks wallets as well as wallets from WildStacks clones which reuse the WildStacks keys.</source>
        <translation>Αυτή η σελίδα σας επιτρέπει την αλληλεπίδραση με την κοινόχρηστη βάση δεδομένων δαχτυλιδιού. Αυτή η βάση δεδομένων προορίζεται για χρήση στα πορτοφόλια του WildStacks, όπως και κλώνους του, οι οποίοι επαναχρησιμοποιούν τα κλειδιά του Μonero.</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <source>In order to obscure which inputs in a WildStacks transaction are being spent, a third party should not be able to tell which inputs in a ring are already known to be spent. Being able to do so would weaken the protection afforded by ring signatures. If all but one of the inputs are known to be already spent, then the input being actually spent becomes apparent, thereby nullifying the effect of ring signatures, one of the three main layers of privacy protection WildStacks uses.&lt;br&gt;To help transactions avoid those inputs, a list of known spent ones can be used to avoid using them in new transactions. Such a list is maintained by the WildStacks project and is available on the wildstacks.net website, and you can import this list here.&lt;br&gt;Alternatively, you can scan the blockchain (and the blockchain of key-reusing WildStacks clones) yourself using the wildstacks-blockchain-mark-spent-outputs tool to create a list of known spent outputs.&lt;br&gt;</source>
        <translation>Για να αποκρύψετε ποιες είσοδοι ξοδεύονται σε μια συναλλαγή WildStacks, ένας τρίτος δεν πρέπει να είναι σε θέση να ξεχωρίσει το ποιες είσοδοι είναι ήδη γνωστό ότι δαπανώνται σε έναν δακτύλιο. Το να μπορεί να γίνει αυτό θα εξασθενίσει την προστασία που παρέχεται από τις υπογραφές του δακτυλίου. Εάν είναι γνωστό ότι έχουν ήδη δαπανηθεί όλες εκτός από μία από τις εισόδους, τότε η είσοδος που ξοδεύεται στην πραγματικότητα γίνεται εμφανής, ακυρώνοντας έτσι την επίδραση των υπογραφών του δακτυλίου, ένα από τα τρία βασικά επίπεδα προστασίας της ιδιωτικότητας που χρησιμοποιεί το WildStacks. &lt;br&gt;Για να βοηθήσετε τις συναλλαγές να αποφύγουν αυτές τις εισροές, μια λίστα γνωστών δαπανών μπορεί να χρησιμοποιηθεί για να αποφευχθεί η χρήση τους σε νέες συναλλαγές. Μια τέτοια λίστα διατηρείται από το WildStacks και είναι διαθέσιμη στον ιστότοπο wildstacks.net και μπορείτε να εισάγετε αυτήν τη λίστα εδώ. &lt;br&gt;Εναλλακτικά, μπορείτε να σαρώσετε μόνοι σας το blockchain (και τα blockchain των κλώνων WildStacks που επαναχρησιμοποιούν κλειδιά) με το εργαλείο wildstacks-blockchain-mark-spent-outputs για τη δημιουργία μιας λίστας γνωστών εξαγόμενων δαπανών.&lt;br&gt;</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <source>In order to avoid nullifying the protection afforded by WildStacks&apos;s ring signatures, an output should not be spent with different rings on different blockchains. While this is normally not a concern, it can become one when a key-reusing WildStacks clone allows you to spend existing outputs. In this case, you need to ensure this existing outputs uses the same ring on both chains.&lt;br&gt;This will be done automatically by WildStacks and any key-reusing software which is not trying to actively strip you of your privacy.&lt;br&gt;If you are using a key-reusing WildStacks clone too, and this clone does not include this protection, you can still ensure your transactions are protected by spending on the clone first, then manually adding the ring on this page, which allows you to then spend your WildStacks safely.&lt;br&gt;If you do not use a key-reusing WildStacks clone without these safety features, then you do not need to do anything as it is all automated.&lt;br&gt;</source>
        <translation>Προκειμένου να αποφευχθεί η ακύρωση της προστασίας που παρέχεται από τις υπογραφές δακτυλίων του WildStacks, μια έξοδος δεν πρέπει να δαπανάται με διαφορετικούς δακτυλίους σε διαφορετικά blockchain. Αν και αυτό συνήθως δεν προκαλεί ανησυχία, μπορεί να προκαλέσει όταν ο κλώνος WildStacks που επαναχρησιμοποιεί τα κλειδιά, σας επιτρέπει να ξοδέψετε υπάρχουσες εξόδους. Σε αυτήν την περίπτωση, πρέπει να διασφαλίσετε ότι η υπάρχουσα έξοδος χρησιμοποιεί τον ίδιο δακτύλιο και στις δύο αλυσίδες. &lt;br&gt;Αυτό θα γίνει αυτόματα από το WildStacks και από οποιοδήποτε λογισμικό επαναχρησιμοποίησης κλειδιών που δεν προσπαθεί να αφαιρέσει ενεργά το απόρρητό σας. &lt;br&gt;Εάν χρησιμοποιείτε και έναν κλώνο WildStacks που επαναχρησιμοποιεί κλειδιά και αυτός ο κλώνος δεν περιλαμβάνει αυτήν την προστασία, μπορείτε ακόμα να διασφαλίσετε ότι οι συναλλαγές σας προστατεύονται δαπανώντας πρώτα στον κλώνο και, στη συνέχεια, προσθέτοντας χειροκίνητα τον δακτύλιο σε αυτήν τη σελίδα, όπου σας επιτρέπει να ξοδέψετε το WildStacks σας με ασφάλεια. &lt;br&gt;Εάν δεν χρησιμοποιείτε κλώνο WildStacks που επαναχρησιμοποιεί κλειδιά χωρίς αυτά τα χαρακτηριστικά ασφαλείας, τότε δεν χρειάζεται να κάνετε τίποτα, καθώς όλα είναι αυτοματοποιημένα.&lt;br&gt;</translation>
    </message>
    <message>
        <location filename="../pages/SharedRingDB.qml" line="279"/>
        <source>This records rings used by outputs spent on WildStacks on a key reusing chain, so that the same ring may be reused to avoid privacy issues.</source>
        <translation>Αυτό καταγράφει δακτυλίους που χρησιμοποιούνται από εξόδους που δαπανήθηκαν στο WildStacks σε μια αλυσίδα επαναχρησιμοποίησης κλειδιών, έτσι ώστε ο ίδιος δακτύλιος να μπορεί να επαναχρησιμοποιηθεί για να αποφευχθούν ζητήματα απορρήτου.</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>Εισάγετε την Διεύθυνση WildStacks (παράδειγμα: WsaAFFq5kSiGBoZ...)</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <source>Spendable funds: %1 WSTS. Please wait ~%2 minutes for your whole balance to become spendable.</source>
        <translation>Διαθέσιμο κεφάλαιο: %1 WSTS. Παρακαλώ περιμένετε ~%2 λεπτά για να γίνει διαθέσιμο ολόκληρο το υπόλοιπο σας.</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <source>Spend WSTS from a cold (offline) wallet</source>
        <translation>Δαπανήστε WSTS από ένα πορτοφόλι εκτός σύνδεσης</translation>
    </message>
    <message>
...
Μέγεθος Δακτυλίου: </translation>
    ...
    <message>
        ...
        <source>WildStacks sent successfully</source>
        <translation>Επιτυχής αποστολή WildStacks</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <source>WildStacks address</source>
        <translation>Διεύθυνση WildStacks</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <source>New WildStacks version v%1 is available.</source>
        <translation>H νέα έκδοση του WildStacks v%1 είναι διαθέσιμη.</translation>
    </message>
    <message>
        <location filename="../components/UpdateDialog.qml" line="98"/>
        <source>Please visit wildstacks.net for details</source>
        <translation>Για λεπτομέρειες παρακαλώ επισκεφτείτε το wildstacks.net</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <source>To be able to communicate with the WildStacks network your wallet needs to be connected to a WildStacks node. For best privacy it&apos;s recommended to run your own node.</source>
        <translation>Για να μπορείτε να επικοινωνείτε με το δίκτυο WildStacks, το πορτοφόλι σας πρέπει να είναι συνδεδεμένο σε κόμβο WildStacks. Για καλύτερο απόρρητο, συνιστάται να τρέξετε τον δικό σας κόμβο.</translation>
    </message>
</context>
<context>
...
<context>
    ...
    <message>
        ...
        <source>Additionally, you may specify a bootstrap node to use WildStacks immediately.</source>
        <translation>Επιπλέον, μπορείτε να καθορίσετε έναν κόμβο εκκίνησης για άμεση χρήση του WildStacks.</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <source>Welcome to WildStacks</source>
        <translation>Καλώς ήλθατε στο WildStacks</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <source>Choose this option if this is your first time using WildStacks.</source>
        <translation>Κάντε αυτή την επιλογή εάν είναι η πρώτη φορά που χρησιμοποιείτε το WildStacks.</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <source>Connect your hardware wallet to create a new WildStacks wallet.</source>
        <translation>Συνδέστε το υλικό πορτοφόλι σας για την δημιουργία ενός νέου πορτοφολιού WildStacks.</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <source>Temporary use of remote nodes is useful in order to use WildStacks immediately (hence the name bootstrap), however be aware that when using remote nodes (including with the bootstrap setting), nodes could track your IP address, track your &quot;restore height&quot; and associated block request data, and send you inaccurate information to learn more about transactions you make.</source>
        <translation>Η προσωρινή χρήση απομακρυσμένων κόμβων είναι σημαντική για άμεση χρήση του WildStacks (εξ ου και το όνομα bootstrap), ωστόσο να γνωρίζετε ότι όταν χρησιμοποιείτε απομακρυσμένους κόμβους (συμπεριλαμβανομένης της ρύθμισης bootstrap), οι κόμβοι θα μπορούσαν να παρακολουθούν τη διεύθυνση IP σας, να παρακολουθούν το &quot;ύψος επαναφοράς&quot; και συσχετισμένα δεδομένα αιτήματος block και να σας στείλουνε ανακριβείς πληροφορίες για να μάθουνε περισσότερα σχετικά με τις συναλλαγές που πραγματοποιείτε.</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <source>This mode is ideal for managing small amounts of WildStacks. You have access to basic features for making and managing transactions. It will automatically connect to the WildStacks network so you can start using WildStacks immediately.</source>
        <translation>Αυτή η λειτουργία είναι ιδανική για τη διαχείριση μικρών ποσών WildStacks. Έχετε πρόσβαση σε βασικές δυνατότητες για την πραγματοποίηση και διαχείριση συναλλαγών. Θα συνδεθεί αυτόματα στο δίκτυο WildStacks, ώστε να ξεκινήσετε να χρησιμοποιείτε το WildStacks αμέσως.</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <source>Create portable wallets and use them on any PC. Enable if you installed WildStacks on a USB stick, an external drive, or any other portable storage medium.</source>
        <translation>Δημιουργήστε φορητά πορτοφόλια και χρησιμοποιήστε τα σε οποιονδήποτε υπολογιστή. Ενεργοποιήστε εάν εγκαταστήσατε το WildStacks σε USB στικάκι, εξωτερική μονάδα δίσκου ή σε οποιοδήποτε άλλο φορητό μέσο αποθήκευσης.</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <source>To be able to communicate with the WildStacks network your wallet needs to be connected to a WildStacks node. For best privacy it&apos;s recommended to run your own node.

If you don&apos;t have the option to run your own node, there&apos;s an option to connect to a remote node.</source>
        <translation>Για να μπορείτε να επικοινωνείτε με το δίκτυο WildStacks, το πορτοφόλι σας πρέπει να είναι συνδεδεμένο σε κόμβο WildStacks. Για καλύτερο απόρρητο, συνιστάται να τρέξετε τον δικό σας κόμβο.
...
<context>
    ...
    <message>
        ...
        <source>This address received %1 WSTS, with %2 confirmation(s).</source>
        <translation>Αυτή η διεύθυνση έλαβε %1 WSTS, με %2 επιβεβαιώση(-σεις).</translation>
    </message>
    <message>
        <location filename="../main.qml" line="1067"/>
        <source>Good signature</source>
    ...
    <message>
        ...
        <source>Would you like to register WildStacks GUI Desktop entry?</source>
        <translation>Θα θέλατε να εγγραφείτε στην καταχώρηση Γραφικού Περιβάλλοντος Χρήστη του WildStacks Desktop;</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <source>This address received %1 WSTS, but the transaction is not yet mined</source>
        <translation>Αυτή η διεύθυνση έλαβε %1 WSTS, αλλά η συναλλαγή δεν έχει εξορυχθεί ακόμα</translation>
    </message>
    <message>
